...
namespace TestKata
{
    ...
    {
        //Linq sulution:
        public static int Number0(List<int[]> peopleListInOut)
        {
        ...
        private int Number1(List<int[]> peopleListInOut)
        {
            counter = 0;
        ...
        public void ThridTest()
        {
            ...
            Assert.AreEqual(21, Number0(peopleList));
            Assert.AreEqual(21, Number1(peopleList));
        }
    }
}
